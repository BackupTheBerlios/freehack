...
\label{classCSurfaceChild}\index{CSurfaceChild@{CSurfaceChild}}
...
\begin{center}
\leavevmode
\includegraphics[height=3cm]{classCSurfaceChild}
\end{center}
\end{figure}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}CSurface\-Child::CSurface\-Child (SDL\_\-Surface $\ast$ {\em surface})}\label{classCSurfaceChild_a0}
...
\end{Desc}
\index{CSurfaceChild@{CSurface\-Child}!~CSurfaceChild@{$\sim$CSurfaceChild}}
\index{~CSurfaceChild@{$\sim$CSurfaceChild}!CSurfaceChild@{CSurface\-Child}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}virtual CSurface\-Child::$\sim${\bf CSurface\-Child} ()\hspace{0.3cm}{\tt  [virtual]}}\label{classCSurfaceChild_a1}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}virtual SDL\_\-Surface$\ast$ CSurface\-Child::Get\-Destination\-Surface ()\hspace{0.3cm}{\tt  [virtual]}}\label{classCSurfaceChild_a6}
...
\index{CSurfaceChild@{CSurface\-Child}!GetX@{GetX}}
\index{GetX@{GetX}!CSurfaceChild@{CSurface\-Child}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}virtual int CSurface\-Child::Get\-X ()\hspace{0.3cm}{\tt  [virtual]}}\label{classCSurfaceChild_a4}
...
\begin{Desc}
\item[Siehe auch:]{\bf Get\-Y()}{\rm (S.\,\pageref{classCSurfaceChild_a5})}\end{Desc}
\index{CSurfaceChild@{CSurface\-Child}!GetY@{GetY}}
\index{GetY@{GetY}!CSurfaceChild@{CSurface\-Child}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}virtual int CSurface\-Child::Get\-Y ()\hspace{0.3cm}{\tt  [virtual]}}\label{classCSurfaceChild_a5}
...
\begin{Desc}
\item[Siehe auch:]{\bf Get\-X()}{\rm (S.\,\pageref{classCSurfaceChild_a4})}\end{Desc}
\index{CSurfaceChild@{CSurface\-Child}!SetDestinationSurface@{SetDestinationSurface}}
\index{SetDestinationSurface@{SetDestinationSurface}!CSurfaceChild@{CSurface\-Child}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}virtual void CSurface\-Child::Set\-Destination\-Surface (SDL\_\-Surface $\ast$ {\em dest})\hspace{0.3cm}{\tt  [virtual]}}\label{classCSurfaceChild_a2}
...
\item[Siehe auch:]{\bf CSurface\-Child()}{\rm (S.\,\pageref{classCSurfaceChild_a0})}\end{Desc}
\index{CSurfaceChild@{CSurface\-Child}!SetPosition@{SetPosition}}
\index{SetPosition@{SetPosition}!CSurfaceChild@{CSurface\-Child}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}virtual void CSurface\-Child::Set\-Position (int {\em newx}, int {\em newy})\hspace{0.3cm}{\tt  [virtual]}}\label{classCSurfaceChild_a3}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}SDL\_\-Surface$\ast$ {\bf CSurface\-Child::destination}}\label{classCSurfaceChild_o0}


Das SDL\_\-Surface in dem die Ausgabe stattfinden bzw. in dem gezeichnet wird. 

\index{CSurfaceChild@{CSurface\-Child}!x@{x}}
\index{x@{x}!CSurfaceChild@{CSurface\-Child}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int {\bf CSurface\-Child::x}}\label{classCSurfaceChild_o1}


Die x-Position des Objekts relativ zu {\em destination\/}. 

\index{CSurfaceChild@{CSurface\-Child}!y@{y}}
\index{y@{y}!CSurfaceChild@{CSurface\-Child}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int {\bf CSurface\-Child::y}}\label{classCSurfaceChild_o2}
...
\item 
versuch2/{\bf surfacechild.h}\end{CompactItemize}
