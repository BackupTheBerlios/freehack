/* Ein weiteres Beispiel für CList.
 * 
 ...
 * In dem Fall kann man auch NULL zur Liste hinzufügen, und den das
 * Objekt erst später anlegen, was in diesem Beispiel gezeigt wird.
 */
